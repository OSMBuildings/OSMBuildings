...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @class GLMap
	 */
	var Basemap = global.GLMap = (function() {
	  ...
	  var constructor = function(container, options) {
	    ...
	    this.pointer = new Basemap.Pointer(this, this.container);
	...
	// TODO: this should be directly integrated with a standalone build of OSM Buildings
	...
	Basemap.Pointer = function(map, container) {
	  this.map = map;
	  ...
	  var resizeDebounce;
	  this._addListener(window, 'resize', function() {
	    if (resizeDebounce) {
	      return;
	    }
