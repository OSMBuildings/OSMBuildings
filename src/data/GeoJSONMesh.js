...
var GeoJSONMesh = function(tileX, tileY, zoom) {
  this.tileX = tileX;
  this.tileY = tileY;
  this.zoom = zoom;
...
var position = geojson.features[0].geometry.coordinates[0][0];
this.zoom = 16;
var xy = project(position[1], position[0], TILE_SIZE <<this.zoom);
this.tileX = xy.x / TILE_SIZE <<0;
this.tileY = xy.y / TILE_SIZE <<0;
